...
%pointer_functions(ADLX_RGB, rgbTypeP);
%pointer_functions(ADLX_Point, pointTypeP);
%pointer_functions(ADLX_IntRange, intRangeTypeP);
%pointer_functions(ADLX_UINT16_RGB, uint16RgbTypeP);
...
%}
%enddef
%ppointer_functions(IADLXDisplayServices*, displayServicesP_Ptr);
%ppointer_functions(IADLXDisplayList*, displayListP_Ptr);
%ppointer_functions(IADLXDisplay*, displayP_Ptr);
%ppointer_functions(IADLXDisplayChangedHandling*, displayChangeHandlingP_Ptr);
...
%ppointer_functions(IADLXManualGraphicsTuning1*, manualGraphicsTuning1P_Ptr);
%ppointer_functions(IADLXManualGraphicsTuning2*, manualGraphicsTuning2P_Ptr);
...
%ppointer_functions(IADLXGPUTuningChangedEvent*, gpuTuningChangedEventP_Ptr);
%ppointer_functions(IADLXGPUTuningChangedListener*, gpuTuningChangedListenerP_Ptr);
%ppointer_functions(IADLXGPUTuningChangedHandling*, gpuTuningChangedHandlingP_Ptr);
%ppointer_functions(IADLXGPUTuningServices*, gpuTuningServicesP_Ptr);
...
%ppointer_functions(IADLXSystemMetricsList*, systemMetricsListP_Ptr);
...
%ppointer_functions(IADLXGPUsEventListener*, gpusEventListenerP_Ptr);
%ppointer_functions(IADLXGPUsChangedHandling*, gpusChangedHandlingP_Ptr);
%ppointer_functions(IADLXSystem*, systemP_Ptr);
